...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
	   $insert_product = mysqli_query($conn, "UPDATE `cart` SET Qty = Qty+1 WHERE ItemName = '$product_name'");
      $message[] = 'Product was added to cart again succesfully';
   }else{
      $insert_product = mysqli_query($conn, "INSERT INTO `cart`(ItemName, ItemPrice, ItemPhoto, Qty) VALUES('$product_name', '$product_price', '$product_image', '$product_quantity')");
