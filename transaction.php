                    ...
                    <table class="table1">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql = "SELECT invoices.SalesDate, users.Name, invdetails.InvNo AS invNo, SUM(ItemPrice*invdetails.Qty) AS Amount FROM invdetails JOIN items ON items.ItemID=invdetails.ItemID JOIN invoices ON invoices.InvNo=invdetails.invNo JOIN users ON users.UserID=invoices.UserID WHERE invoices.UserID ='$userID' GROUP BY InvNo";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="inv-view.php?invoice=<?php echo $row['invNo']?>"><button>View</button></a> 
                                            </td>
                                        </tr>
                                    <?php }
                                } else {
